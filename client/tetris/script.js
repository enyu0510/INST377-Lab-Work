document.addEventListener("DOMContentLoaded", () => {
  ...
  //randomly select tetromino in first rotation
  ...
  //move tetromino left unless at edge or blockage
  function moveLeft() {
    undraw();
  ...
  //show up next teromino in minigrid
  ...
  function displayShape() {
    //remove any trace of tetromino form entire grid
